...
// ---------------- Fact ↔ Interview index ----------------
// Which AdminInterviews touched (taught/strengthened) a given fact, derived
// from each interview's questionIds → AIQuestion.affectedFactIds.

export const factInterviewIndex: Record<string, string[]> = (() => {
