...
export const Route = createFileRoute("/interview/$id")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Resolve your queue with the voice agent." },
    ],
  }),
  ...
  errorComponent: ({ error, reset }) => (
    <div className="grid min-h-screen place-items-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-2xl text-ink">Interview unavailable</h1>
  ...
  notFoundComponent: () => (
    <div className="grid min-h-screen place-items-center bg-background px-4">
      <div className="text-center">
        <h1 className="text-2xl text-ink">Interview not found</h1>
...
function RouteComponent() {
  ...
  return <InterviewPage sessionId={id} />;
}