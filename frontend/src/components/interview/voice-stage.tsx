  ...
  return (
    <div className="relative grid h-[220px] w-[220px] place-items-center">
      ...
      <motion.div
        ...
        transition={{
          duration: phase === "speaking" ? 2.2 : 3.4,
          repeat: Infinity,
          ease: "easeInOut",
        }}
      />
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow:
            "inset 0 -20px 40px color-mix(in oklab, var(--accent) 60%, black), inset 0 20px 40px color-mix(in oklab, var(--accent) 30%, white)",
        }}
        animate={
          active ? { scale: [1, 1.04, 0.98, 1], rotate: [0, 8, -4, 0] } : { scale: 1, rotate: 0 }
        }
